...
translate french strings:
    ...
    new "L'emplacement a finalement été abandonné par Vacuo lorsque la source d'eau essentielle de Red Cliffs est soudainement tombée à sec. À l'époque moderne, l'emplacement a été pris par le White Fang, car on a découvert que la composition chimique particulière des roches de Red Cliffs provoquait des interférences dans un certain nombre d'instruments avancés."
    ...
    new "Le White Fang a récemment été contraint de quitter la fortification alors que la Chute de Beacon a attiré une attention accrue sur les activités du White Fang à l'échelle de Remnant, y compris à Vacuo. Pourtant, sa familiarité et son isolement l'a amené à être choisi comme lieu de rencontre entre la Chef Suprême des White Fang, Sienna Khan, et son subordonné traître, Adam Taurus."
    ...
    new "Le White Fang a récemment été contraint de quitter la fortification alors que la Chute de Beacon a attiré une attention accrue sur les activités du White Fang à l'échelle de Remnant, y compris à Vacuo."
    ...
    new "Une décennie après la fermeture de la ville, ses mystères ont été dévoilés et son champ d'action brisé par un groupe d'étudiants de l'Académie de Chasse de Beacon. Bien que les détails aient jusqu'à présent été gardés secrets, l'incident et la disparition de sa population qui en a résulté ont été attribués aux machinations de l'un de ses résidents : Weser van Goethe, ancien élève de Beacon. L'homme est actuellement recherché, sa localisation étant inconnue."
    ...
    new "Après la Chute de Beacon, la ville rouverte fut revendiquée par la diaspora de l'Académie de Beacon et le chapitre valésien de l'Organisation de Chasse, refusant de se mettre à genoux devant la nouvelle administration atlésienne. Si au début une horreur aux yeux du Conseil de Vale, la rhétorique s'est adoucie lorsque Peak a proposé de commencer à accueillir des réfugiés de guerre de Mistral : en échange, Peak a été reconnue comme une ville du Royaume de Vale."
    ...
    new "Après deux ans et demi d'existence, la Mairie de Vale allait regretter sa décision alors que la ville commençait à attirer également des citoyens valésiens hostiles à l'influence croissante d'Atlas : en particulier des agriculteurs. La goutte d'eau qui fera déborder le vase viendra le 1er Attia 492 : historiquement le jour où la famille royale valésienne abdiqua suite à la Grande Guerre, Peak annonça son intention de faire sécession du Royaume de Vale, formant le Duché Royal de Peak sous la direction de la Duchesse Glynda Goodwitch Première."
    ...
    new "Une conférence internationale sur la sécurité est désormais prévue pour le 1er Konté, à laquelle participeront toutes les nations connues de Remnant : le sort de la cité-État nouveau-née sera décidé à cette date."
    ...
    new "Au plus fort de la première vague d'organisations et de mouvements pour les droits du peuple Fauni, une conférence s'est tenue où une solution a été vantée : relocaliser tous les peuples Fauni sur l'Île de Ménagerie, au large de la côte sud du Mistral. Solution qui, aux yeux des dirigeants fauni, ressemblait davantage à une insulte, car la majeure partie de l'île était couverte par un désert chaud et habitable et peuplée d'espèces rares et dangereuses de Grimms. Pourtant, ils le prendraient."
    ...
    new "Bien que le plan de ségrégation à peine voilé ait échoué, car il y a toujours un nombre toujours croissant de fauni partout en Remnant, personne ne nierait qu'ils ont fait de l'île - ou du moins des parties habitables de la côte nord - leur patrie. Grâce à une diplomatie magistrale, la Ménagerie a prospéré au fil des décennies, au point de presque manquer d'espace pour de nouvelles constructions."
    ...
    new "Ces derniers temps, ces contraintes, l’évolution de la situation internationale et les actions du White Fang ont amené les dirigeants de la nation, les Belladonna, à reconsidérer bon nombre de leurs politiques, y compris leur neutralité historique. La conférence de sécurité au cours de laquelle ils accueilleront des représentants de haut niveau de toutes les nations de Remnant, sans Mistral, sera le terrain d'essai de ce changement."
