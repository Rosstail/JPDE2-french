...
translate french strings:
    ...
    new "Le troisième leader de l'histoire du White Fang et aussi le dernier, puisque suite à son violente prise de pouvoir, Adam Taurus a décidé de le renommer Red Fang. Pour mieux refléter ses origines et ses objectifs sanglants."
    ...
    new "À l'origine ouvrier dans une exploitation minière de la Société Schnee à Mistral, les mauvaises conditions de travail et un surveillant particulièrement abusif ont laissé Adam Taurus aveugle. Sa blessure l'a rendu incapable de travailler et de subvenir à ses besoins, et lorsqu'un raid du White Fang a finalement fermé le camp, il était sur le point de mourir."
    ...
    new "Parallèlement à son salut, Adam a reçu quelque chose d’encore plus précieux : un but. Il rejoignit le Fang et, malgré son handicap, grandit rapidement dans les rangs de l'organisation grâce à ses prouesses martiales et ses capacités de leadership. Sa radicalisation s'est également accrue, en grande partie à cause d'un autre membre avec lequel il a eu une relation amoureuse."
    ...
    new "Après avoir reçu le titre de Rokutsume pour la région de Vale, son couronnement fut la Chute de Beacon. Seul son entourage connaît tous les détails de l'opération, mais les résultats sont évidents aux yeux de tous : la plus grande perte de vies humaines dans le Royaume de Vale depuis la Grande Guerre et la destruction de la plus prestigieuse académie de chasseurs de Remnant. Les conséquences à l’échelle internationale, si possible, ont été encore plus dévastatrices."
    ...
    new "Trois ans plus tard, fort de sa suprématie martiale, de son influence croissante et de sa vision extrémiste, Adam Taurus vise toujours plus haut : la direction du Fang et l'éradication de l'humanité toxique et des traîtres."
