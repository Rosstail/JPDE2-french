...
translate french dialogue_Mint_f10bb988:
    ...
    ma_mi "Félicitations pour ta mission...{w=0.5} Et pour avoir été le premier à utiliser l'Aura Drop Cannon pendant une vraie mission."
...
translate french dialogue_Mint_15fca0fd:
    ...
    d nulla "Heh...{w=0.5} Je vais pas mentir, c'était drôle en fait."
...
translate french dialogue_Mint_9ad1dba8:
    ...
    ma_mi "Frères!{w=0.3} Seul un chasseur pourrait trouver le fait de se faire tirer dessus 'drôle'...{w=0.5} Bon après, c'est pas la chose la plus folle qui soit arrivé sur ce dirigeable, pas vrai?"
...
translate french dialogue_Magenta_ca6c7fb8:
    ...
    ma_ma "Félicitations pour ta gradation, Chasseur di Kabegis."
...
translate french dialogue_Magenta_08ffffb5:
    ...
    d nulla "Merci...{w=0.5} Mais cela va me prendre du temps avant de m'habituer à ce titre."
...
translate french dialogue_Magenta_f683c7f2:
    ...
    ma_ma "Hey, si je peux passer de garder quelqu'un à prendre des ordres venant de lui dans une armée complètement différente mais sur le même dirigeable, je peux m'habituer à ça."
...
translate french dialogue_Magenta_596e13b8:
    ...
    d nulla "Le connaissant ?{w=0.3} Probablement les deux."
