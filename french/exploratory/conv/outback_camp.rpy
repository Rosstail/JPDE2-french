...
translate french outback_talk_evelyn_2e7cadb0:
    ...
    # d smile "And what are you all grins about?"
    d smile "Et pourquoi es-tu tout sourire ?"

# game/exploratory/conv/outback_camp.rpy:85
...
translate french outback_talk_evelyn_75c30d98:
    ...
    # d neutral "It's less her actual physical age and more her attitude.{w=0.3} She is looking down on us, I can feel it."
    d neutral "C'est moins son âge physique et plus son attitude.{w=0.3} Elle nous méprise, je peux le sentir."

# game/exploratory/conv/outback_camp.rpy:93
translate french outback_talk_evelyn_8d329bde:

    # e nulla "Oh, definitely.{w=0.3} Are you gonna let her get away with it?"
    e nulla "Oh, définitivement.{w=0.3} Tu vas la laisser s'en tirer comme ça ?"

# game/exploratory/conv/outback_camp.rpy:94
translate french outback_talk_evelyn_be96d39d:

    # d neutral "Absolutely not.{w=0.3} Whatever it is she wants us to do, we will {i}excel{/i}."
    d neutral "Absolument pas.{w=0.3} Qu'importe ce qu'elle veut qu'on fasse, nous allons {i}exceller{/i}."

# game/exploratory/conv/outback_camp.rpy:96
translate french outback_talk_evelyn_f28bb851:

    # e nulla "Hm-hmmm~{w=0.5} And theeeeen...?"
    e nulla "Hm-hmmm~{w=0.5} Et aprèèèès... ?"

# game/exploratory/conv/outback_camp.rpy:97
translate french outback_talk_evelyn_ea44a47b:

    # d neutral "And then I-"
    d neutral "Et après je-"

# game/exploratory/conv/outback_camp.rpy:99
...
translate french outback_talk_evelyn_583aa8a1:
    ...
    # e nulla "Love of my life, that is literally among your duties as the aforementioned.{w=0.3} Now titillate my imagination a little bit more, I'm bored!"
    e nulla "Amour de ma vie, c'est littéralement dans tes devoirs comme celui susmentionné.{w=0.3} Titille maintenant mon imagination un peu plus, je m'ennuie !"

# game/exploratory/conv/outback_camp.rpy:110
translate french outback_talk_evelyn_03a6358a:

    # e nulla "So, what do you think we're dealing with...?{w=0.3} Any ideas?"
    e nulla "Alors, on a affaire à qui à ton avis ?{w=0.3} Une idée ?"

# game/exploratory/conv/outback_camp.rpy:111
translate french outback_talk_evelyn_74c8ffe4:

    # d neutral "Not many...{w=0.5} What about you?"
    d neutral "Pas beaucoup...{w=0.5} Et toi ?"
...
translate french outback_talk_evelyn_a5f991fd:
    ...
    d smile "Et deux d'entre elles étaient faibles aux Dégâts de Feu...{w=0.5} Quelque chose à garder en tête."

# game/exploratory/conv/outback_camp.rpy:120
...
translate french outback_talk_ruby_4c31fda4:
    ...
    # d surprise "You seem excited...?"
    d surprise "Tu as l'air excitée... ?"

# game/exploratory/conv/outback_camp.rpy:136
translate french outback_talk_ruby_02eaba33:

    # ru nulla "Maybe a little!{w=0.3} Does it show...?"
    ru nulla "Peut-être un peu !{w=0.3} Ça se voit... ?"

# game/exploratory/conv/outback_camp.rpy:137
...
translate french outback_talk_ruby_c1b3189f:
    ...
    # ru nulla "I know...{w=0.5} But I'm looking forward to showing Maria what I can do against an opponent who won't fold easily."
    ru nulla "Je sais...{w=0.5} Mais j'ai hâte de montrer à Maria ce que je peux faire contre un adversaire qui ne pliera pas facilement."

# game/exploratory/conv/outback_camp.rpy:141
translate french outback_talk_ruby_23fe8512:

    # ru nulla "And maybe I'll be able to show you guys what the Silver Eyes can do...{w=0.5} I've never used them against a Gargantuan."
    ru nulla "Et peut-être que je pourrai vous montrer ce que les Yeux Argentés peuvent faire...{w=0.5} Je ne les ai jamais utilisés contre un Gargantuesque."

# game/exploratory/conv/outback_camp.rpy:142
translate french outback_talk_ruby_0cfc5821:

    # d amused "Oh, right, the Silver Eyes...{w=0.5} I hope it's gonna look cool?"
    d amused "Oh, c'est vrai, les Yeux Argentés...{w=0.5} J'espère que ça aura l'air cool ?"

# game/exploratory/conv/outback_camp.rpy:144
translate french outback_talk_ruby_6e7ba448:

    # ru nulla "Cooler than cool.{w=0.3} Ice cold."
    ru nulla "Plus cool que cool.{w=0.3} Glacé."

# game/exploratory/conv/outback_camp.rpy:155
translate french outback_talk_maria_69dd0e01:

    # m nulla "[p_n], I wanted to ask you something...{w=0.5} I've noticed that you haven't been using your Semblance."
    m nulla "[p_n], je voulais te demander quelque chose...{w=0.5} J'ai remarqué que tu n'avais pas utilisé ta Semblance."

# game/exploratory/conv/outback_camp.rpy:156
...
translate french outback_talk_maria_c2253cc1:
    ...
    # m nulla "I see...{w=0.5} Would it cause you harm?"
    m nulla "Je vois...{w=0.5} Cela te ferait-il du mal ?"

# game/exploratory/conv/outback_camp.rpy:158
translate french outback_talk_maria_cbce2c60:

    # d neutral "That's more or less it."
    d neutral "C'est plus ou moins ça."

# game/exploratory/conv/outback_camp.rpy:159
...
translate french outback_talk_maria_5e7decf2:
    ...
    # d smile "Yes.{w=0.3} Those I can use no problem as long as I have Aura, don't worry."
    d smile "Oui.{w=0.3} Je peux les utiliser sans problème tant que j'ai de l'Aura, ne t'inquiète pas"

# game/exploratory/conv/outback_camp.rpy:161
...
translate french outback_talk_maria_9b051438:
    ...
    # m nulla "As someone who has been unable to rely on them for decades, [p_n]...{w=0.5} Don't trust your eyes too much."
    m nulla "En tant que personne qui n'a pas pu compter sur eux depuis des décennies, [p_n]...{w=0.5} Ne fais pas trop confiance en tes yeux."

# game/exploratory/conv/outback_camp.rpy:169
translate french outback_talk_maria_c46c58c0:

    # d surprise "Huh?"
    d surprise "Hein ?"

# game/exploratory/conv/outback_camp.rpy:170
...
translate french outback_talk_maria_d5c7ad7e:
    ...
    d_i neutral "(Qu'à t-elle pu vouloir dire... ?)"
