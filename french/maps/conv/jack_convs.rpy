...
translate french jack_outback_fields_8cd4acfe:
    ...
    j nulla "Pas grand chose, juste...{w=0.5} À quel point le ciel est bleu, tu vois ?{w=0.3} Il a une teinte que tu ne peux voir que si tu es assez proche des côtes."
...
translate french jack_outback_fields_89f19cbd:
    ...
    j nulla "Promis.{w=0.3} Ma mère meurt de tous vous rencontrer, de fou."
...
translate french jack_outback_fields_f13fd46c:
    ...
    j nulla "Bien que, hmm, J'appécierai que Evelyn et toi pouviez vous retenir de...{w=0.5} Tu sais, quand on est là.{w=0.3} Vous risquez de lui faire faire une crise cardiaque."
...
translate french jack_outback_cliffs_f2c2c585:
    ...
    d smile "Tu as vu sa tête quand tu as dis que étions ceux qui avons tué le Ghamera ?{w=0.5} Je veux dire, c'était quand même assez bien contrôlé, mais j'imagine que c'est son équivalent à la sidération."
...
translate french jack_outback_cliffs_48121c2e:
    ...
    j nulla "J'approuve, c'était la chose la plus dangereuse que nous avons jamais fait, mais au moins j'ai le droit de me venter sur un Grimm Gargantuesque."
...
translate french jack_outback_cliffs_973d0486:
    ...
    d neutral "Partenaire, juste au cas où...{w=0.5} Tu {i}n'es pas{/i} autorisée d'utiliser la stratégie 'attends ton heure', qu'importe à quel point ça devient risqué."
...
translate french jack_outback_cliffs_df311cd6:
    ...
    j nulla "Tu t'inquiète pour ton chef d'équipe, n'est-ce pas ?{w=0.3} Je suis touchée."
...
translate french jack_outback_cliffs_ef10cdb6:
    ...
    j nulla "Et tu n'est pas autorisé d'essayer et de te faire exploser.{w=0.3} Ou d'essayer et brûler ton Aura en cendres.{w=0.3} Ou d'utiliser ta Semblance.{w=0.3} Ou-"
...
translate french jack_outback_cliffs_687a673f:
    ...
    d amused "D'accord, d'accord, tu as raison, partenaire !{w=0.3} N'empêche, plus aucun sacrifice de la part de quiconque, entendu ?"
...
translate french jack_outback_cliffs_2b234e25:
    ...
    j nulla "Je me demande quelle est l'histoire entre Maria et son partenaire...{w=0.5} Avec la perte de ses yeux et tout."
...
translate french jack_outback_cliffs_3e2f5c0b:
    ...
    d surprise "Ouais...{w=0.5} Elle n'a donné l'impression qu'elle est morte mais...{w=0.5} Quel genre de 'prix' a-t'elle pu payer, pour sauver la vie de Maria ?"
