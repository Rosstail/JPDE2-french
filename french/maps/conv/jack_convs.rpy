...
translate french jack_outback_fields_8dc8dd0f:
    ...
    d smile "Qu'est-ce qui te fait sourire, partenaire ?"
...
translate french jack_outback_fields_8cd4acfe:
    ...
    j nulla "Pas grand chose, juste...{w=0.5} À quel point le ciel est bleu, tu comprends ?{w=0.3} Il a une teinte que tu ne peux voir que si tu es assez proche d'une côte."

# game/maps/conv/jack_convs.rpy:20
translate french jack_outback_fields_0ae5671f:

    # j nulla "Reminds me of home."
    j nulla "Ça me rappelle la maison."
...
translate french jack_outback_fields_89f19cbd:
    ...
    j nulla "Promis.{w=0.3} Ma mère meurt d'envie de tous vous rencontrer, pour tout te dire."
...
translate french jack_outback_fields_f13fd46c:
    ...
    j nulla "Bien que, hmm, j'appécierai qu'Evelyn et toi puissiez vous retenir de...{w=0.5} Tu sais, quand on est là.{w=0.3} Vous risquez de lui faire faire une crise cardiaque."
...
translate french jack_outback_cliffs_c5ebe75e:
    ...
    j nulla "Je pense qu'on a enfin réussi à la surprendre."
...
translate french jack_outback_cliffs_f2c2c585:
    ...
    d smile "Tu as vu sa tête quand tu as dis qu'on était ceux qui ont tué le Ghamera ?{w=0.5} Je veux dire, c'était quand même assez bien contrôlé, mais j'imagine que c'est son équivalent de la sidération."
...
translate french jack_outback_cliffs_48121c2e:
    ...
    j nulla "Je te l'accorde, c'était la chose la plus dangereuse qu'on a jamais fait, mais au moins j'ai le droit de me venter du Grimm Gargantuesque."
...
translate french jack_outback_cliffs_973d0486:
    ...
    d neutral "Partenaire, juste au cas où...{w=0.5} Tu {i}n'es pas{/i} autorisée à utiliser la stratégie 'attends ton heure', peu importe à quel point ça devient risqué."
...
translate french jack_outback_cliffs_df311cd6:
    ...
    j nulla "Tu t'inquiètes pour ton chef d'équipe, n'est-ce pas ?{w=0.3} Je suis touchée."
...
translate french jack_outback_cliffs_ef10cdb6:
    ...
    j nulla "Et tu n'est pas autorisé à essayer et à te faire exploser.{w=0.3} Ou à essayer et à brûler ton Aura en cendres.{w=0.3} Ou à utiliser ta Semblance.{w=0.3} Ou-"
...
translate french jack_outback_cliffs_687a673f:
    ...
    d amused "D'accord, d'accord, j'ai compris, partenaire !{w=0.3} N'empêche, plus aucun sacrifice de la part de quiconque, entendu ?"

# game/maps/conv/jack_convs.rpy:51
translate french jack_outback_cliffs_e741bbc0:

    # j nulla "Agreed!{w=0.3} Speaking of partners..."
    j nulla "Entendu !{w=0.3} En parlant de partenaires..."
...
translate french jack_outback_cliffs_2b234e25:
    ...
    j nulla "Je me demande quelle est l'histoire entre Maria et sa partenaire...{w=0.5} Avec la perte de ses yeux et tout."
...
translate french jack_outback_cliffs_3e2f5c0b:
    ...
    d surprise "Ouais...{w=0.5} Elle n'a pas donné l'impression qu'elle est morte mais...{w=0.5} Quel genre de 'prix' a-t'elle pu payer, pour sauver la vie de Maria ?"
...
translate french jack_outback_cliffs_b506e85c:
    ...
    j nulla "Aussi, je sais qu'elle était plus jeune et moins expérimentée mais...{w=0.5} Quel genre d'ennemi aurait été capable de faire ça à Maria ?"
