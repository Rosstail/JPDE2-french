...
translate french outback_talk_04_13185727:
    ...
    e nulla "Et à chaque fois que c'est arrivé, il était l'enfant en ville le plus cool pour toute une semaine !{w=0.3} Des bombes de table gratuites pour tout le monde !"
...
translate french outback_talk_05_45d063fe:
    ...
    e amused "Alooors, tu vas parler ou est-ce que je dois penser que c'est un braquage ?"
...
translate french outback_talk_05_8375e729:
    ...
    ru nulla "Je voulais juste te remercier...{w=0.5} Mais je ne sais pas comment mettre des mots dessus."
...
translate french outback_talk_05_82dfbefd:
    ...
    ru nulla "Je reste un peu partagée à propos de tout le truc mais...{w=0.5} Maintenant j'ai l'opportunité de démêler ce désordre, tu comprends ?"
...
translate french outback_talk_05_00454c22:
    ...
    e nulla "Je comprends.{w=0.3} Crois-moi, je donnerai n'importe quoi pour être à ta place maintenant.{w=0.3} Prends-en bien soin, donc."
...
translate french outback_talk_05_08829d48:
    ...
    ru nulla "Je vois...{w=0.5} Et ton cousin est plus jeune de combien d'années ?"
...
translate french outback_talk_05_227e4121:
    ...
    ru nulla "Yang était encore plus jeune que ça quand elle nous a presque tuées toutes les deux."
...
translate french outback_talk_05_006ebb4b:
    ...
    ru nulla "On ferait mieux de les rattraper.{w=0.3} Enfin, je dis juste que tu peux faire tout un tas de choses stupides quand tu es aussi jeune.{w=0.3} Surtout sans surveillance."
...
translate french outback_talk_06_dd7b4451:
    ...
    j nulla "Merde.{w=0.3} C'est un bon point...{w=0.5} Tu penses que Maria et Ruby auraient de l'argent que l'on pourrait emprunter ?"
...
translate french outback_talk_06_8da136b7:
    ...
    p nulla "Très probablement.{w=0.3} Mais même avec, on ne sait pas si ce sera suffisant...{w=0.5} Devrais-je faire une requête pour des fonds supplémentaires avant que le Shark ne parte ?"
