...
translate french outback_talk_03_ab69ebed:
    ...
    p surprise "Hmmm...{w=0.5} Déroutant."
...
translate french outback_interact_02_e45b9947:
    ...
    d nulla "Aussi, {i}définitivement{/i} juste pour du Grimm de bas niveau.{w=0.3} Je veux dire..."
...
translate french outback_interact_02_c786a6bf:
    ...
    p nulla "Elle aime être minutieuse, je suppose... ?"
...
translate french outback_interact_02_2bb621e6:
    ...
    d nulla "Je suis reconnaissant de ne pas avoir besoin de surveiller chacun de mes pas, mais est-ce que ça ne va pas à l'encontre du but recherché ?"
...
translate french outback_talk_04_908c8fae:
    ...
    j nulla "Il a l'air d'être un mec super sympa."
...
translate french outback_talk_04_bb17f93f:
    ...
    j nulla "Oh...{w=0.5} Il était le père d'Andrea ?"
...
translate french outback_talk_04_4c8640bb:
    ...
    e nulla "Ouais...{w=0.5} Disons simplement qu'ils ont peut-être un peu trop utilisé la carotte et pas assez le bâton avec celui-là."

# game/maps/outback_02.rpy:366
translate french outback_talk_04_2e1649dd:

    # e nulla "No pun intended."
    e nulla "Sans mauvais jeu de mot."
...
translate french outback_talk_05_45d063fe:
    ...
    e amused "Alooors, tu as quelque chose à dire ou est-ce que je dois penser que c'est un braquage ?"
...
translate french outback_talk_05_25623450:
    ...
    ru laugh blush g_up "Eeeeek !{w=0.3} Désolé, désolé, je suis si désolé !"
...
translate french outback_talk_05_8375e729:
    ...
    ru nulla "Je voulais juste te remercier...{w=0.5} Mais je ne sais même pas comment le dire avec mes mots."
...
translate french outback_talk_05_54062f2d:
    ...
    e nulla "Oh, tais-toi.{w=0.3} C'est toi qui a tout fait."
...
translate french outback_talk_05_520d9407:
    ...
    ru nulla "Mais tu es celle qui m'a poussé à le faire...{w=0.5} Et Je ne pourrais pas être plus heureuse."
...
translate french outback_talk_05_82dfbefd:
    ...
    ru nulla "Je reste un peu confuse à propose de tout le truc mais...{w=0.5} Maintenant j'ai l'opportunité de démêler ce désordre, tu sais ?"
...
translate french outback_talk_05_00454c22:
    ...
    e nulla "Je le sais.{w=0.3} Crois-moi, Je donnerai n'importe quoi pour être à ta place maintenant.{w=0.3} Prends-en bien soin, donc."

# game/maps/outback_02.rpy:398
translate french outback_talk_05_2a02aade:

    # ru nulla "I will..."
    ru nulla "Je le ferai..."

# game/maps/outback_02.rpy:401
translate french outback_talk_05_da5efbe8:

    # e nulla "Uhm, is there something else?"
    e nulla "Umh, y a t-il quelque chose d'autre ?"
...
translate french outback_talk_05_08829d48:
    ...
    ru nulla "Je vois...{w=0.5} Et quel point ton cousin est plus jeune ?"
...
translate french outback_talk_05_227e4121:
    ...
    ru nulla "Yang était encore plus jeune que ça quand elle nous a presque tué toutes les deux."

# game/maps/outback_02.rpy:422
translate french outback_talk_05_0a64b2c0:

    # e nulla "She...{w=0.5} She what?"
    e nulla "Elle...{w=0.5} Elle a failli quoi ?"
...
translate french outback_talk_05_c486fec6:
    ...
    d surprise "Les filles !{w=0.3} Tout va bien, là-bas ?"
...
translate french outback_talk_05_006ebb4b:
    ...
    ru nulla "On ferait mieux de les rattraper.{w=0.3} Enfin, je dis juste que tu peux faire tout un tas de choses stupides quand tu es aussi jeune.{w=0.3} Surtout sans guidance parental"

# game/maps/outback_02.rpy:441
translate french outback_talk_06_8cf6a082:

    # p surprise "Uhm, Jack, can I speak to you for a moment?"
    p surprise "Hum, Jack, je peux te parler un moment ?"

# game/maps/outback_02.rpy:448
translate french outback_talk_06_bdd115fb:

    # j nulla "Something's wrong, Penny?"
    j nulla "Quelque chose ne va pas, Penny ?"
...
translate french outback_talk_06_02fd43a6:
    ...
    p nulla "Eh bien... Pas vraiment mal mais...{w=0.5} J'étais en train de réfléchir à ce qu'on devrait faire après en avoir fini avec le Grimm Gargantuesque."
...
translate french outback_talk_06_eb4f7bd4:
    ...
    p nulla "Comme le Red Shark doit partir avant qu'on soit apte à rentrer, nous aurons besoin de passer la nuit quelque part.{w=0.3} Ensuite nous devrons réserver un passage en bateau vers le continent Vacuovalesien...{w=0.5} Je ne suis pas sure que nos fonds puissent couvrir ceci."
...
translate french outback_talk_06_dd7b4451:
    ...
    j nulla "Merde.{w=0.3} C'est un bon point...{w=0.5} Tu penses que Maria et Ruby aurait de l'argent que nous pourrions emprunter ?"
...
translate french outback_talk_06_8da136b7:
    ...
    p nulla "Très probablement.{w=0.3} Mais même avec, nous ne savons pas si ce sera suffisant...{w=0.5} Devrais-je faire une requête pour des fonds supplémentaires avant que le Shark ne parte ?"
...
translate french outback_talk_06_81e3d780:
    ...
    j nulla "Fais donc.{w=0.3} Je n'aime pas nos chances de trouver un job à temps partiel par ici."